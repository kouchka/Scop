...
#    Updated: 2019/09/17 14:36:55 by allallem         ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
LIB		= -L libui/libft -L libui -lft -lui -L$(HOME)/.brew/lib -L$(HOME)/.brew/Cellar/glew/2.1.0/lib -lSDL2 -lSDL2_ttf -lSDL2_image -framework OpenGL -lglew
...
install:
	brew reinstall SDL2 && brew reinstall SDL2_image && brew reinstall sdl2_ttf
