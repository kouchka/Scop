...
/*   Updated: 2019/05/23 15:34:30 by allallem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void				ft_putaddress_dprintf(void *add, char c, t_pfspe *p, int b);
...
void				ft_flag_plus_space_dprintf(t_pfspe *point,
	long long int content);
void				ft_puts_field_dprintf(t_pfspe *point, char c,
	long long int content);
void				ft_puts_precision_dprintf(t_pfspe *point);
void				ft_putnbr_dprintf(long long int n, t_pfspe *point);
void				ft_putpercent_dprintf(t_pfspe *point);
void				ft_putstr_dprintf(char const *str, t_pfspe *point);
void				ft_adjustaddress_dprintf(t_pfspe *p, char c, char *str);
void				ft_calculate_address_dprintf(t_pfspe *p, char *str, char c);
int					ft_special_address_dprintf(unsigned long long int n, char c,
	t_pfspe *p);
...
int					ft_flags_dprintf(char const *str, void *content,
	t_pfspe *point);
void				ft_flagssmaj_dprintf(t_pfspe *p, void *address);
char				*ft_bstrjoin(char *str1, char *str2);
char				*ft_fstrjoin(char *str1, char *str2);
