...
/*   Updated: 2019/01/17 17:09:15 by allallem         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	if (c == 'd' || c == 'i' || c == 'D')
		ft_dprintfdi(c, point, (long long int)content);
	else if (c == 's')
		ft_dprintfs(point, (char *)content);
	else if (c == 'p')
		ft_putaddress_dprintf(content, c, point, 16);
	else if (c == 'x')
		ft_putaddress_dprintf(content, c, point, 16);
	else if (c == 'X')
		ft_putaddress_dprintf(content, c, point, 16);
	else if (c == 'o' || c == 'O')
		ft_putaddress_dprintf(content, c, point, 8);
	else
		return (0);
	return (1);
}

int				ft_flags_dprintf(char const *str, void *content, t_pfspe *point)
{
	int i;
